...
(
    ...
    "DisplayName"               VARCHAR(50)  COLLATE dbo.case_insensitive NOT NULL,
    "PenHostName"               VARCHAR(255) COLLATE dbo.case_insensitive NOT NULL,
    "IPAddress"                 VARCHAR(15)  COLLATE dbo.case_insensitive NOT NULL,
